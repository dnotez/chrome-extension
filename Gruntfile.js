...
module.exports = function (grunt) {
  ...
  require('grunt-coffee-jshint')(grunt);
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      coffee: {
        ...
        tasks: ['coffee:chrome', 'browserify:debug'],
        options: {
          livereload: true
        }
      },
    ...
    coffee_jshint: {
      options: {
        globals: ['console', 'module', '$', 'chrome', 'document', 'require', 'WebSocket']
      },
      all: [
      ...
      dist: {
        options: {
          archive: function () {
            ...
            return 'package/pList-' + manifest.version + '.zip';
          }
        },
        files: [{
          expand: true,
    ...
    browserify: {
      debug: {
        files: {
          '<%= config.app %>/scripts/browserified/contentutil.js': ['app/scripts/contentutil.js'],
          '<%= config.app %>/scripts/browserified/stackoverflow.js': ['app/scripts/stackoverflow.js'],
